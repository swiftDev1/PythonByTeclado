...
print(1, 2, 3, 4, 5, sep=" - ")  
'''
the default separator is " ". It is kind of a default parameter as well.
Run print(1,2,3,4,5) to see this in action. Also notice how print can take mutliple arguments and 
prints them on one line separated by space.
