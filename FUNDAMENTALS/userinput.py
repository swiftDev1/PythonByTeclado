#MY MAIN TAKEAWAY
"""
First notice that we can use triple quotes to create multi-line
comments in Python. This was originally used to create multi-line
string without the issue of line breaks.
We already know that the input function is used to get user input,
and this returns a string. So, if you wanna perform any calculation,
you need to first convert it to a number using the int function.
"""
