"""
Mehn this concept is not clear at all.
Well, @classmethod is used when you need access to the class object inside the code.
@staticmethod is used when you don't need access to self.
