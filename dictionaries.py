"""
You should read through but my main takeaways are that a list of dictionaries usually comes in handy,
You can easily convert a list of lists or a list of tuples into a dictionary by passing the list into
dict()
"""
...
# You can turn a list of lists or list of tuples into a dictionary:
