...
# Gives you those members that aren't in both sets. Exact opposite of intersection
...
print(all_friends)
print(not_in_both.union(art_and_science))  #This shows that symmetric difference is the opposite of intersection